...
public class ShapeFactory {
	...
	/**
	 * Конструктор, инициализирующий объект по готовому экземпляру shape
	 * Поскольку для параметров stroke и paint позволительно значение null,
	 * то они не указываются в конструкторе
	 * @param shape
	 */
	...
	/**
	 * Конструктор, инициализирующий объект по одному из значений enum'a
	 * @param ShapeForm одно из значений ShapeFactory.ShapeForm
	 */
	...
	/**@deprecated
	 * Этот конструктор является устаревшим и сохранен для совместимости
	 * Используйте ShapeFactory (ShapeForm form)
	 * 
	 * @param shape_type
	 *            Двузначное число, определяющее тип фигуры: 1й разряд - форма
	 *            фигуры 2й разряд - тип линии, образующей фигуру
	 */
	 ...
	 *            Число двойных ребер
	 * @param center
	 *            Точка, в которой находится центр
	 * @param rOuter
	 *            Внешний радиус
	 * @param rInner
	 *            Внутренний радиус
